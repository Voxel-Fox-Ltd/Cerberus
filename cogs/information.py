...
class Information(utils.Cog):
    ...
    @commands.command()
    async def points(self, ctx:utils.Context, user:typing.Optional[discord.User], duration:typing.Optional[utils.converters.DurationConverter]=utils.Duration('days', 7)):
